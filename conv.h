 ...
 * to the col and row fields automatically / magically performs the calculations
 ...
 * stack object away.
 * 
 * † The actual layout with respect to the order of the fields in memory is up to the 
 * compiler based on the processor architecture. The intent and optimial storage is 
 * still achieved however regardless of the order in physical memory.
 * 
 */
struct conv1_t {
private:
